...
fn test_format_listen_address() {
    ...
    // Test with IPv6
    assert_eq!(format_listen_address(None, "::1", 8080), "::1:8080");

    // Test with different ports
    assert_eq!(format_listen_address(None, "0.0.0.0", 80), "0.0.0.0:80");

    assert_eq!(format_listen_address(None, "0.0.0.0", 443), "0.0.0.0:443");
}
