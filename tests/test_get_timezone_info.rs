...
fn test_get_timezone_info() {
    ...
    assert!(
        info.get("timezones").is_some(),
        "Should have 'timezones' field"
    );
    assert!(
        info.get("timezone_groups").is_some(),
    ...
    assert!(
        groups.contains_key("us_timezones"),
        "Should have us_timezones group"
    );
    assert!(
        groups.contains_key("europe_timezones"),
        "Should have europe_timezones group"
    );
    assert!(
        groups.contains_key("asia_timezones"),
        "Should have asia_timezones group"
    );
}
