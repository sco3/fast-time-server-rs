...
fn test_get_business_hours() {
    ...
    assert!(
        regions.contains_key("north_america"),
        "Should have north_america region"
    );
    ...
    assert!(
        na.contains_key("standard_hours"),
        "north_america should have standard_hours"
    );
    assert!(
        na.contains_key("lunch_break"),
        "north_america should have lunch_break"
    );
    assert!(
        na.contains_key("working_days"),
        "north_america should have working_days"
    );
